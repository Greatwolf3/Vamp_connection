...
Route::group(
    ...
    Route::get('/crea_png_admin','PlayerController@crea_png_admin')->name("crea_png_admin")->middleware('master');
    Route::post('/save_png','ApiController@save_png')->name("save_png")->middleware('master');

    Route::get('/crea_evento_admin','EventoController@crea_evento_admin')->name("crea_evento_admin")->middleware('master');
